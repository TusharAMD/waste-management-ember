<?php
function Hala_maps_render($params) {
    ...
    wp_enqueue_script('maps-api', Hala_URI_PATH_FR . "/shortcodes/map/maps.js",array(),'1.0.0');
    /* Map Style defualt */
    $map_styles = array(
...
if(function_exists('hala_shortcode')) { hala_shortcode('maps', 'Hala_maps_render'); }