<?php
function motivoweb_video($params, $content = null){
	extract(shortcode_atts(array(
	'height' => 200,
	'width' => '100%'
	), $params));
	wp_enqueue_script('fitvids', Hala_URI_PATH_FR . "/shortcodes/video/fitvids.js");
...
if(function_exists('hala_shortcode')) { hala_shortcode('tb-video', 'motivoweb_video'); }