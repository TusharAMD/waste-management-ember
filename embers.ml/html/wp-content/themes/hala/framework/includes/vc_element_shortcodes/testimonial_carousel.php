...
vc_map ( array (
	...
	"params" => array (
		...
		array(
			...
			"param_name" => "col_lg",
			"value" => "",
			"description" => esc_html__("Please, enter number Columns Large devices Desktops (>=1200px) in this element. Default: 1", 'hala')
		),
		array(
			"type" => "textfield",
			"class" => "",
			...
			"param_name" => "col_md",
			"value" => "",
			"description" => esc_html__("Please, enter number Columns Medium devices Desktops (>=992px) in this element. Default: 1", 'hala')
		),
		array(
			"type" => "textfield",
			"class" => "",
			...
			"param_name" => "col_sm",
			"value" => "",
			"description" => esc_html__("Please, enter number Columns Small devices Tablets (>=768px) in this element. Default: 1", 'hala')
		),
		array(
			"type" => "textfield",
			"class" => "",
		...
		array(
			...
			"value" => "",
			"description" => esc_html__("Please, enter number space between items in this element. Default:0", 'hala')
		),
		array(
			"type" => "dropdown",
			"class" => "",
