...
vc_map ( array (
	...
	"params" => array (
		...
		array (
			...
			"description" => esc_html__( "Note: By default, all your team will be displayed. If you want to narrow output, select category(s) above. Only selected categories will be displayed.", 'hala' )
	   ),
		array (
			"type" => "textfield",
