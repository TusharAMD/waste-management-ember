...
class Hala_PostLove {
	...
	function __construct($post_id = null)   {
        ...
        add_action('wp_ajax_nectar-love', array($this, 'Hala_ajax_love'));
		add_action('wp_ajax_nopriv_nectar-love', array($this, 'Hala_ajax_love'));
	}
	...
	function Hala_ajax_love($post_id) {
		//update
		if( isset($_POST['loves_id']) ) {
			$post_id = str_replace('nectar-love-', '', $_POST['loves_id']);
			echo $this->Hala_love_post($post_id, 'update');
		}
		//get
		else {
			$post_id = str_replace('nectar-love-', '', $_POST['loves_id']);
			echo $this->Hala_love_post($post_id, 'get');
		}
		exit;
	}
	function Hala_love_post($post_id, $action = 'get')
	{
	...
	function add_love() {
		global $post;
		$output = $this->Hala_love_post($post->ID);
  		$class = 'nectar-love';
  		$icon = 'fa fa-heart-o';
...
global $Hala_post_favorite;
$Hala_post_favorite = new Hala_PostLove();
function Hala_post_favorite() {
	global $Hala_post_favorite;
	echo $Hala_post_favorite->add_love();
}