<?php
/**
* Plugin Name: hala Shortcodes
* Plugin URI: http://motivoweb.com
* Description: This plugin is addon visual composer, which is developed by hala Team for Visual Comporser plugin.
* Version: 1.1
* Author: hala
* Author URI: http://motivoweb.com
* Copyright 2017 motivoweb.com. All rights reserved.
*/
define( 'TBBS_NAME', 'hala' );
...
/* Autoupdate */
/*require hala_INCLUDES . 'plugin-update-checker-3.1/plugin-update-checker.php';
/**
...
/**
 * Use hala_shortcodes class
 */
new hala_shortcodes;

/**
 * hala_shortcodes Class
 * 
 */

class hala_shortcodes
{
	...
	function include_scripts_admin()
	{
		...
		wp_enqueue_script( 'tbbs-script-admin', TBBS_JS . 'jquery.hala-shortcodes.admin.js', array( 'jquery' ), '1.0', true );
		wp_enqueue_style( 'tbbs-script-admin', TBBS_CSS . 'hala-shortcodes.admin.css', array(), '1.0' );
	}
	...
	function include_scripts()
	{
		 ...
		 * Lib JS Tbbs Plugin
		 */
		wp_enqueue_script( 'tbbs-script', TBBS_JS . 'jquery.hala-shortcodes.js', array( 'jquery', 'dynamics' ), '1.0', true );
		wp_localize_script( 'tbbs-script', 'bsObj', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ) ) );
		wp_enqueue_style( 'tbbs-script', TBBS_CSS . 'hala-shortcodes.css', array(), '1.0' );
	}
	...
	{ 
		$page_title		= __( 'hala Shortcode', TBBS_NAME ); 
		$menu_title		= __( 'hala Shortcode', TBBS_NAME );
		$capability		= 'manage_options'; 
		$menu_slug		= 'hala-shortcode-settings'; 
