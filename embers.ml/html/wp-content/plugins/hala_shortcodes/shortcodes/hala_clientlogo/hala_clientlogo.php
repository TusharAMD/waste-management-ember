...
vc_map(
	array(
		"name" => __( "hala Client Logo", TBBS_NAME ),
	    "base" => "hala_clientlogo",
	    "class" => "vc-hala-clientlogo",
	    "icon" => "tb-icon-for-vc",
...
class WPBakeryShortCode_hala_clientlogo extends WPBakeryShortCode
{
...
/**
 * tbbs_halaClientlogoParams
 *
 */
if( ! function_exists( 'tbbs_halaClientlogoParams' ) ) :
	function tbbs_halaClientlogoParams()
	{
		return array(
			array(
				'name' => 'height',
