...
vc_map(
	array(
		"name" => __( "hala Textillate", TBBS_NAME ),
	    "base" => "hala_textillate",
	    "class" => "vc-hala-textillate",
	    "icon" => "tb-icon-for-vc",
...
class WPBakeryShortCode_hala_textillate extends WPBakeryShortCode
{
...
/**
 * tbbs_halaTextillateLib
 */
if( ! function_exists( 'tbbs_halaTextillateLib' ) ) :
	function tbbs_halaTextillateLib( $scripts )
	{	
		...
		array_push( $scripts, array(
			...
			'type' => 'js',
			'handle' => 'lettering',
			'src' => TBBS_URL . 'shortcodes/hala_textillate/assets/js/jquery.lettering.js',
			'deps' => array( 'jquery' ),
			'include' => 1,
			) );
		...
		array_push( $scripts, array(
			...
			'type' => 'js',
			'handle' => 'textillate',
			'src' => TBBS_URL . 'shortcodes/hala_textillate/assets/js/jquery.textillate.js',
		...
		array_push( $scripts, array(
			...
			'type' => 'css',
			'handle' => 'textillate',
			'src' => TBBS_URL . 'shortcodes/hala_textillate/assets/css/animate.css',
			'include' => 1,
			) );
...
add_filter( 'tbbs_register_scripts', 'tbbs_halaTextillateLib' );

if( ! function_exists( 'hala_halaTextillateParams' ) ) :
	function hala_halaTextillateParams()
	{
		return array(
			array(
				'name' => 'text_template',
