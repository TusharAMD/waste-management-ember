...
vc_map(
	array(
		"name" => __( "hala Heading", TBBS_NAME ),
	    "base" => "hala_heading",
	    "class" => "vc-hala-heading",
	    "icon" => "tb-icon-for-vc",
...
class WPBakeryShortCode_hala_heading extends WPBakeryShortCode
{
...
/**
 * tbbs_halaHeadingDefaultParams
 *
 */
if( ! function_exists( 'tbbs_halaHeadingDefaultParams' ) ) :
	function tbbs_halaHeadingDefaultParams()
	{
		return array(
			array(
